        ...
        <div className="relative" ref={ref}>
            ...
            {open && (
                <div className="absolute right-0 z-20 mt-2 w-80 rounded-xl border border-slate-200 bg-white p-2 shadow-lg">
                    <p className="px-2 py-1.5 text-sm font-semibold text-slate-800">
                        Citas por confirmar
                    </p>
                            ...
                            {pending!.map((appt) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="mt-1 text-xs font-medium text-emerald-600 hover:underline disabled:opacity-50"
                                    >
                                        Confirmar
                                    </button>
                                </li>
                    ...
                    <Link
                        ...
                        className="mt-1 block rounded-lg px-2 py-1.5 text-center text-sm font-medium text-brand hover:bg-slate-50"
                    >
                        Ver toda la agenda
                    </Link>
                </div>
